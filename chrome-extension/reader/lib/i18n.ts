...
const messages: Record<Locale, Record<string, string>> = {
  'en': {
    ...
    // Slice 1 #8 — Codex BYOK preset (OpenAI Codex via ChatGPT subscription)
    'options.byok-codex.login.btn':                                 'Log in with ChatGPT',
    'options.byok-codex.login.helpText':                            "Uses your ChatGPT subscription's Codex quota. Tokens stay on this device.",
    'options.byok-codex.login.pending.instructions':                'A new tab opened to ChatGPT. Sign in and paste this code:',
    'options.byok-codex.login.cancel':                              'Cancel',
    // Slice 4 #23 — copy-to-clipboard button on the user_code chip.
    'options.byok-codex.login.copy':                                'Copy',
    'options.byok-codex.login.copied':                              'Copied!',
    'options.byok-codex.login.copyFailed':                          'Copy failed',
    'options.byok-codex.section.label':                             'ChatGPT account',
    'options.byok-codex.loggedIn.label':                            'Logged in as {email}',
    'options.byok-codex.logout.btn':                                'Log out',
    'options.byok-codex.error.startFailed':                         'Could not start the ChatGPT login. Check your internet connection and try again.',
    'options.byok-codex.error.reloginRequired':                     'Your ChatGPT session expired. Please log in again.',
    'options.byok-codex.onboarding.title':                          'Enable device authorization in your ChatGPT settings',
    'options.byok-codex.onboarding.body':                           'ChatGPT requires you to enable device-code authorization once before any non-browser client (including PaperFlow) can sign in. Open settings, turn on the toggle, then click Log in again.',
    'options.byok-codex.onboarding.openSettings':                   'Open ChatGPT settings',
    'options.byok-codex.onboarding.dismiss':                        'Got it',

    'codex-error.relogin':                                          'ChatGPT session expired. Re-login to keep using your subscription.',
    'codex-error.api-changed':                                      'Codex API may have changed. Switch to another BYOK provider to keep working.',
    'codex-error.open-options':                                     'Open Options',
    'codex-error.network':                                          'Network error reaching the Codex service. Check your connection and try again.',
    // Slice 3 #25 — fired by reconcileActiveCodexModel when the stored Codex
    // model id is no longer in the live /codex/models list (OpenAI removed
    // it, tier downgrade, etc). Both {old} and {new} are interpolated.
    'codex-error.model-switched':                                   'Codex model "{old}" is no longer available. Switched to "{new}".',
  ...
  'zh-CN': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 '用 ChatGPT 登录',
    'options.byok-codex.login.helpText':                            '调用你 ChatGPT 订阅自带的 Codex 配额，凭据只存在本机。',
    'options.byok-codex.login.pending.instructions':                '已新开标签页跳转到 ChatGPT，请登录账号并粘贴下方验证码：',
    'options.byok-codex.login.cancel':                              '取消',
    'options.byok-codex.login.copy':                                '复制',
    'options.byok-codex.login.copied':                              '已复制！',
    'options.byok-codex.login.copyFailed':                          '复制失败',
    'options.byok-codex.section.label':                             'ChatGPT 账号',
    'options.byok-codex.loggedIn.label':                            '已登录：{email}',
    'options.byok-codex.logout.btn':                                '退出登录',
    'options.byok-codex.error.startFailed':                         '无法开始 ChatGPT 登录流程，请检查网络后重试。',
    'options.byok-codex.error.reloginRequired':                     'ChatGPT 会话已失效，请重新登录。',
    'options.byok-codex.onboarding.title':                          '请在 ChatGPT 设置中开启“设备授权”',
    'options.byok-codex.onboarding.body':                           'ChatGPT 要求所有非浏览器客户端（含 PaperFlow）首次登录前，在账号"安全"设置里开启"设备授权"开关。打开设置开启开关后再回来点击登录。',
    'options.byok-codex.onboarding.openSettings':                   '打开 ChatGPT 设置',
    'options.byok-codex.onboarding.dismiss':                        '知道了',

    'codex-error.relogin':                                          'ChatGPT 会话已过期，请重新登录以继续使用订阅额度。',
    'codex-error.api-changed':                                      'Codex API 可能已变更，请切换到其他 BYOK 服务以继续使用。',
    'codex-error.open-options':                                     '打开设置',
    'codex-error.network':                                          '无法连接到 Codex 服务，请检查网络后重试。',
    'codex-error.model-switched':                                   'Codex 模型「{old}」已不可用，已切换到「{new}」。',
  ...
  'zh-TW': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 '使用 ChatGPT 登入',
    'options.byok-codex.login.helpText':                            '使用你 ChatGPT 訂閱自帶的 Codex 配額，憑證僅存放在本機。',
    'options.byok-codex.login.pending.instructions':                '已開啟新分頁前往 ChatGPT，請登入帳號並貼上下方驗證碼：',
    'options.byok-codex.login.cancel':                              '取消',
    'options.byok-codex.login.copy':                                '複製',
    'options.byok-codex.login.copied':                              '已複製！',
    'options.byok-codex.login.copyFailed':                          '複製失敗',
    'options.byok-codex.section.label':                             'ChatGPT 帳號',
    'options.byok-codex.loggedIn.label':                            '已登入：{email}',
    'options.byok-codex.logout.btn':                                '登出',
    'options.byok-codex.error.startFailed':                         '無法開始 ChatGPT 登入流程，請檢查網路後重試。',
    'options.byok-codex.error.reloginRequired':                     'ChatGPT 工作階段已失效，請重新登入。',
    'options.byok-codex.onboarding.title':                          '請在 ChatGPT 設定中開啟「裝置授權」',
    'options.byok-codex.onboarding.body':                           'ChatGPT 要求所有非瀏覽器用戶端（含 PaperFlow）首次登入前，在帳號「安全」設定裡開啟「裝置授權」開關。開啟設定後再回來點擊登入。',
    'options.byok-codex.onboarding.openSettings':                   '開啟 ChatGPT 設定',
    'options.byok-codex.onboarding.dismiss':                        '了解',

    'codex-error.relogin':                                          'ChatGPT 工作階段已過期，請重新登入以繼續使用訂閱額度。',
    'codex-error.api-changed':                                      'Codex API 可能已變更，請切換到其他 BYOK 服務以繼續使用。',
    'codex-error.open-options':                                     '開啟設定',
    'codex-error.network':                                          '無法連線到 Codex 服務，請檢查網路後重試。',
    'codex-error.model-switched':                                   'Codex 模型「{old}」已無法使用，已切換到「{new}」。',
  ...
  'ja': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 'ChatGPT でログイン',
    'options.byok-codex.login.helpText':                            'ChatGPT サブスクリプションの Codex クォータを使用します。資格情報はこの端末にのみ保存されます。',
    'options.byok-codex.login.pending.instructions':                '新しいタブで ChatGPT を開きました。ログインして以下のコードを貼り付けてください：',
    'options.byok-codex.login.cancel':                              'キャンセル',
    'options.byok-codex.login.copy':                                'コピー',
    'options.byok-codex.login.copied':                              'コピーしました！',
    'options.byok-codex.login.copyFailed':                          'コピー失敗',
    'options.byok-codex.section.label':                             'ChatGPT アカウント',
    'options.byok-codex.loggedIn.label':                            'ログイン中：{email}',
    'options.byok-codex.logout.btn':                                'ログアウト',
    'options.byok-codex.error.startFailed':                         'ChatGPT ログインを開始できませんでした。ネットワークを確認して再試行してください。',
    'options.byok-codex.error.reloginRequired':                     'ChatGPT のセッションが切れました。再ログインしてください。',
    'options.byok-codex.onboarding.title':                          'ChatGPT の設定で「デバイス認可」を有効にしてください',
    'options.byok-codex.onboarding.body':                           'ChatGPT では、ブラウザ以外のクライアント（PaperFlow を含む）が初めてサインインする前に、アカウントの「セキュリティ」設定で「デバイスコード認可」を有効にする必要があります。設定で有効にしてから、もう一度ログインを押してください。',
    'options.byok-codex.onboarding.openSettings':                   'ChatGPT 設定を開く',
    'options.byok-codex.onboarding.dismiss':                        'わかりました',

    'codex-error.relogin':                                          'ChatGPT のセッションが切れました。サブスクリプションを使い続けるには再ログインしてください。',
    'codex-error.api-changed':                                      'Codex API が変更された可能性があります。別の BYOK プロバイダーに切り替えてください。',
    'codex-error.open-options':                                     '設定を開く',
    'codex-error.network':                                          'Codex サービスに接続できません。ネットワークを確認してもう一度お試しください。',
    'codex-error.model-switched':                                   'Codex モデル「{old}」は利用できなくなりました。「{new}」に切り替えました。',
  ...
  'ko': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 'ChatGPT으로 로그인',
    'options.byok-codex.login.helpText':                            'ChatGPT 구독에 포함된 Codex 할당량을 사용합니다. 자격 증명은 이 기기에만 저장됩니다.',
    'options.byok-codex.login.pending.instructions':                'ChatGPT가 새 탭에서 열렸습니다. 로그인 후 아래 코드를 붙여넣으세요:',
    'options.byok-codex.login.cancel':                              '취소',
    'options.byok-codex.login.copy':                                '복사',
    'options.byok-codex.login.copied':                              '복사되었습니다!',
    'options.byok-codex.login.copyFailed':                          '복사 실패',
    'options.byok-codex.section.label':                             'ChatGPT 계정',
    'options.byok-codex.loggedIn.label':                            '로그인됨: {email}',
    'options.byok-codex.logout.btn':                                '로그아웃',
    'options.byok-codex.error.startFailed':                         'ChatGPT 로그인을 시작할 수 없습니다. 네트워크를 확인한 후 다시 시도하세요.',
    'options.byok-codex.error.reloginRequired':                     'ChatGPT 세션이 만료되었습니다. 다시 로그인해 주세요.',
    'options.byok-codex.onboarding.title':                          'ChatGPT 설정에서 기기 인증을 활성화하세요',
    'options.byok-codex.onboarding.body':                           'ChatGPT는 브라우저가 아닌 클라이언트(PaperFlow 포함)가 처음 로그인하기 전에 계정의 보안 설정에서 기기 코드 인증을 활성화하도록 요구합니다. 설정에서 활성화한 후 다시 로그인 버튼을 누르세요.',
    'options.byok-codex.onboarding.openSettings':                   'ChatGPT 설정 열기',
    'options.byok-codex.onboarding.dismiss':                        '확인',

    'codex-error.relogin':                                          'ChatGPT 세션이 만료되었습니다. 구독 사용을 계속하려면 다시 로그인하세요.',
    'codex-error.api-changed':                                      'Codex API가 변경되었을 수 있습니다. 다른 BYOK 공급자로 전환하세요.',
    'codex-error.open-options':                                     '설정 열기',
    'codex-error.network':                                          'Codex 서비스에 연결할 수 없습니다. 네트워크를 확인하고 다시 시도하세요.',
    'codex-error.model-switched':                                   'Codex 모델 "{old}"을(를) 더 이상 사용할 수 없어 "{new}"(으)로 전환했습니다.',
  ...
  'fr': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 'Se connecter avec ChatGPT',
    'options.byok-codex.login.helpText':                            'Utilise le quota Codex de votre abonnement ChatGPT. Les identifiants restent sur cet appareil.',
    'options.byok-codex.login.pending.instructions':                'Un nouvel onglet a été ouvert vers ChatGPT. Connectez-vous et collez ce code :',
    'options.byok-codex.login.cancel':                              'Annuler',
    'options.byok-codex.login.copy':                                'Copier',
    'options.byok-codex.login.copied':                              'Copié !',
    'options.byok-codex.login.copyFailed':                          'Échec de la copie',
    'options.byok-codex.section.label':                             'Compte ChatGPT',
    'options.byok-codex.loggedIn.label':                            'Connecté en tant que {email}',
    'options.byok-codex.logout.btn':                                'Se déconnecter',
    'options.byok-codex.error.startFailed':                         'Impossible de démarrer la connexion ChatGPT. Vérifiez votre connexion et réessayez.',
    'options.byok-codex.error.reloginRequired':                     'Votre session ChatGPT a expiré. Veuillez vous reconnecter.',
    'options.byok-codex.onboarding.title':                          "Activez l'autorisation par code dans les paramètres ChatGPT",
    'options.byok-codex.onboarding.body':                           "ChatGPT exige que vous activiez l'autorisation par code une fois avant qu'un client non-navigateur (y compris PaperFlow) puisse se connecter. Ouvrez les paramètres, activez l'option, puis cliquez à nouveau sur Se connecter.",
    'options.byok-codex.onboarding.openSettings':                   'Ouvrir les paramètres ChatGPT',
    'options.byok-codex.onboarding.dismiss':                        "J'ai compris",

    'codex-error.relogin':                                          'Votre session ChatGPT a expiré. Reconnectez-vous pour continuer à utiliser votre abonnement.',
    'codex-error.api-changed':                                      "L'API Codex a peut-être changé. Passez à un autre fournisseur d'IA pour continuer.",
    'codex-error.open-options':                                     'Ouvrir les options',
    'codex-error.network':                                          'Impossible de joindre le service Codex. Vérifiez votre connexion et réessayez.',
    'codex-error.model-switched':                                   'Le modèle Codex « {old} » n\'est plus disponible. Basculé vers « {new} ».',
  ...
  'de': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 'Mit ChatGPT anmelden',
    'options.byok-codex.login.helpText':                            'Nutzt das Codex-Kontingent Ihres ChatGPT-Abonnements. Anmeldedaten verbleiben auf diesem Gerät.',
    'options.byok-codex.login.pending.instructions':                'Ein neuer Tab wurde zu ChatGPT geöffnet. Melden Sie sich an und fügen Sie diesen Code ein:',
    'options.byok-codex.login.cancel':                              'Abbrechen',
    'options.byok-codex.login.copy':                                'Kopieren',
    'options.byok-codex.login.copied':                              'Kopiert!',
    'options.byok-codex.login.copyFailed':                          'Kopieren fehlgeschlagen',
    'options.byok-codex.section.label':                             'ChatGPT-Konto',
    'options.byok-codex.loggedIn.label':                            'Angemeldet als {email}',
    'options.byok-codex.logout.btn':                                'Abmelden',
    'options.byok-codex.error.startFailed':                         'ChatGPT-Anmeldung konnte nicht gestartet werden. Bitte Internetverbindung prüfen und erneut versuchen.',
    'options.byok-codex.error.reloginRequired':                     'Ihre ChatGPT-Sitzung ist abgelaufen. Bitte melden Sie sich erneut an.',
    'options.byok-codex.onboarding.title':                          'Geräteautorisierung in ChatGPT-Einstellungen aktivieren',
    'options.byok-codex.onboarding.body':                           'ChatGPT verlangt, dass Sie die Geräte-Code-Autorisierung einmalig aktivieren, bevor ein Nicht-Browser-Client (einschließlich PaperFlow) sich anmelden kann. Öffnen Sie die Einstellungen, aktivieren Sie den Schalter und klicken Sie dann erneut auf Anmelden.',
    'options.byok-codex.onboarding.openSettings':                   'ChatGPT-Einstellungen öffnen',
    'options.byok-codex.onboarding.dismiss':                        'Verstanden',

    'codex-error.relogin':                                          'Ihre ChatGPT-Sitzung ist abgelaufen. Melden Sie sich erneut an, um Ihr Abonnement weiterhin zu nutzen.',
    'codex-error.api-changed':                                      'Die Codex-API hat sich möglicherweise geändert. Wechseln Sie zu einem anderen BYOK-Anbieter.',
    'codex-error.open-options':                                     'Optionen öffnen',
    'codex-error.network':                                          'Codex-Dienst nicht erreichbar. Bitte Verbindung prüfen und erneut versuchen.',
    'codex-error.model-switched':                                   'Codex-Modell „{old}“ ist nicht mehr verfügbar. Auf „{new}“ umgestellt.',
  ...
  'es': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 'Iniciar sesión con ChatGPT',
    'options.byok-codex.login.helpText':                            'Usa la cuota de Codex de tu suscripción a ChatGPT. Las credenciales se quedan en este dispositivo.',
    'options.byok-codex.login.pending.instructions':                'Se abrió una nueva pestaña en ChatGPT. Inicia sesión y pega este código:',
    'options.byok-codex.login.cancel':                              'Cancelar',
    'options.byok-codex.login.copy':                                'Copiar',
    'options.byok-codex.login.copied':                              '¡Copiado!',
    'options.byok-codex.login.copyFailed':                          'Error al copiar',
    'options.byok-codex.section.label':                             'Cuenta ChatGPT',
    'options.byok-codex.loggedIn.label':                            'Conectado como {email}',
    'options.byok-codex.logout.btn':                                'Cerrar sesión',
    'options.byok-codex.error.startFailed':                         'No se pudo iniciar el inicio de sesión en ChatGPT. Verifica tu conexión y vuelve a intentarlo.',
    'options.byok-codex.error.reloginRequired':                     'Tu sesión de ChatGPT ha caducado. Vuelve a iniciar sesión.',
    'options.byok-codex.onboarding.title':                          'Activa la autorización por dispositivo en los ajustes de ChatGPT',
    'options.byok-codex.onboarding.body':                           'ChatGPT requiere que actives la autorización por código de dispositivo una vez antes de que cualquier cliente que no sea el navegador (incluido PaperFlow) pueda iniciar sesión. Abre los ajustes, activa el interruptor y vuelve a hacer clic en Iniciar sesión.',
    'options.byok-codex.onboarding.openSettings':                   'Abrir ajustes de ChatGPT',
    'options.byok-codex.onboarding.dismiss':                        'Entendido',

    'codex-error.relogin':                                          'Tu sesión de ChatGPT ha expirado. Vuelve a iniciar sesión para seguir usando tu suscripción.',
    'codex-error.api-changed':                                      'La API de Codex puede haber cambiado. Cambia a otro proveedor BYOK para continuar.',
    'codex-error.open-options':                                     'Abrir opciones',
    'codex-error.network':                                          'No se puede conectar al servicio de Codex. Comprueba tu conexión y vuelve a intentarlo.',
    'codex-error.model-switched':                                   'El modelo de Codex «{old}» ya no está disponible. Se cambió a «{new}».',
  ...
  'ru': {
    ...
    // Slice 1 #8 — Codex BYOK preset
    'options.byok-codex.login.btn':                                 'Войти через ChatGPT',
    'options.byok-codex.login.helpText':                            'Использует квоту Codex из вашей подписки ChatGPT. Учётные данные хранятся только на этом устройстве.',
    'options.byok-codex.login.pending.instructions':                'Открылась новая вкладка ChatGPT. Войдите в систему и вставьте этот код:',
    'options.byok-codex.login.cancel':                              'Отмена',
    'options.byok-codex.login.copy':                                'Копировать',
    'options.byok-codex.login.copied':                              'Скопировано!',
    'options.byok-codex.login.copyFailed':                          'Не удалось скопировать',
    'options.byok-codex.section.label':                             'Аккаунт ChatGPT',
    'options.byok-codex.loggedIn.label':                            'Вошли как {email}',
    'options.byok-codex.logout.btn':                                'Выйти',
    'options.byok-codex.error.startFailed':                         'Не удалось начать вход в ChatGPT. Проверьте подключение к интернету и повторите попытку.',
    'options.byok-codex.error.reloginRequired':                     'Сессия ChatGPT истекла. Войдите снова.',
    'options.byok-codex.onboarding.title':                          'Включите авторизацию по коду устройства в настройках ChatGPT',
    'options.byok-codex.onboarding.body':                           'ChatGPT требует один раз включить авторизацию по коду устройства, прежде чем любой не-браузерный клиент (включая PaperFlow) сможет войти. Откройте настройки, включите переключатель и нажмите Войти снова.',
    'options.byok-codex.onboarding.openSettings':                   'Открыть настройки ChatGPT',
    'options.byok-codex.onboarding.dismiss':                        'Понятно',

    'codex-error.relogin':                                          'Сессия ChatGPT истекла. Войдите снова, чтобы продолжить использовать подписку.',
    'codex-error.api-changed':                                      'API Codex могло измениться. Переключитесь на другого провайдера BYOK, чтобы продолжить.',
    'codex-error.open-options':                                     'Открыть настройки',
    'codex-error.network':                                          'Не удалось подключиться к сервису Codex. Проверьте подключение и повторите попытку.',
    'codex-error.model-switched':                                   'Модель Codex «{old}» больше недоступна. Переключено на «{new}».',
